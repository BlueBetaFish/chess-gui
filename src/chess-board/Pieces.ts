...
export default class Piece {
    ...
    constructor(pieceType: PieceType = PieceType.NONE, pieceColor: Color = Color.UNDEFINED) {
        this.pieceType = pieceType;
        this.pieceColor = pieceColor;
    }

    getFENSymbol(): string {
        if (this.pieceColor === Color.BLACK) return this.pieceType.toLowerCase();
        return this.pieceType;
    }

    equals(newPiece: Piece): boolean {
        return this.pieceColor === newPiece.pieceColor && this.pieceType === newPiece.pieceType;
    }
